...
var aws = require('aws-sdk'),
    ...
    impl = {
        ...
        buildLatencyMetricData: function(report) {
        ...
        buildStatusCodeMetricData: function(report) {
            var statusCodes = {
                '2XX': 0,
                '3XX': 0,
                '4XX': 0,
        ...
        CloudWatchPlugin: function(scriptConfig, eventEmitter) {
            ...
            eventEmitter.on('stats', function (report) {
                ...
                var metricData = impl.buildLatencyMetricData(report);
                metricData = metricData.concat(impl.buildStatusCodeMetricData(report));
                metricData = metricData.concat(impl.buildErrorMetricData(report));
    ...
    api = {
        init: function (scriptConfig, eventEmitter) {
            ...
            impl.cloudWatch = new aws.CloudWatch({region: scriptConfig.plugins[constants.PLUGIN_NAME][constants.PLUGIN_PARAM_NAMESPACE]});
